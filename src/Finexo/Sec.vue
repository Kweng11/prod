...
<div class="container  ">
  ...
  <div class="row">
    <div class="col-md-6 ">
      <div class="img-box">
        <img src="@/assets/finexo/images/about-img.png" alt="">
      </div>
    </div>
    <div class="col-md-6">
      <div class="detail-box">
  ...
  <div class="team_container">
    <div class="row">
      <div class="col-lg-3 col-sm-6">
        <div class="box ">
          <div class="img-box">
            <img src="@/assets/finexo/images/team-1.jpg" class="img1" alt="">
          </div>
          <div class="detail-box">
            <h5>
              Joseph Brown
      ...
      <div class="col-lg-3 col-sm-6">
        <div class="box ">
          <div class="img-box">
            <img src="@/assets/finexo/images/team-2.jpg" class="img1" alt="">
          </div>
          <div class="detail-box">
            <h5>
              Nancy White
      ...
      <div class="col-lg-3 col-sm-6">
        <div class="box ">
          <div class="img-box">
            <img src="@/assets/finexo/images/team-3.jpg" class="img1" alt="">
          </div>
          <div class="detail-box">
            <h5>
              Earl Martinez
      ...
      <div class="col-lg-3 col-sm-6">
        <div class="box ">
          <div class="img-box">
            <img src="@/assets/finexo/images/team-4.jpg" class="img1" alt="">
          </div>
          <div class="detail-box">
            <h5>
              Josephine Allard
  ...
  <div class="carousel-wrap ">
    <div class="owl-carousel client_owl-carousel">
      <div class="item">
        <div class="box">
          <div class="img-box">
            <img src="@/assets/finexo/images/client1.jpg" alt="" class="box-img">
          </div>
          <div class="detail-box">
            <div class="client_id">
      ...
      <div class="item">
        <div class="box">
          <div class="img-box">
            <img src="@/assets/finexo/images/client2.jpg" alt="" class="box-img">
          </div>
          <div class="detail-box">
            <div class="client_id">
              <div class="client_info">
